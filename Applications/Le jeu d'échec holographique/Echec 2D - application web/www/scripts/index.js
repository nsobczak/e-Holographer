...
(function () {
    ...
    function onDeviceReady() {
        ...
        // Connexion du InAppBrowser (iab) sur notre page web
        var iab =  window.open(url, "_blank", "hidden=yes,location=no,zoom=no,hardwareback=no");
        
        // Lorsque l'URL est chargée on affichage l'IAB
